            ...
            <Container size={750} className={classes.inner} >
                ...
                <Grid style={{marginTop:'20px'}} >
                    <Grid.Col span={{ xs: 12, sm: 6 }} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexWrap:'wrap' }}>
                        <Button component="a" href="https://github.com/geracia2" target='_blank' rel='noopener noreferrer' size="xl" variant="default" className={classes.control} leftSection={<GithubIcon size={20} />} >
                            My GitHub
                        </Button>
                        ...
                        <Button component="a" href="https://docs.google.com/document/d/1-3mBPiyLRa14nv4TMan_BD6lsJ7p21tl/edit?usp=drive_link&ouid=116708027853520128681&rtpof=true&sd=true" target='_blank' rel='noopener noreferrer' size="xl" variant="default" className={classes.control} leftSection={<IoDocumentAttach size={20} />} >
                            Resume
                        </Button>
